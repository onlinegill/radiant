...
const GUIDE = [
  {
    title: 'Chat & agents',
    items: [
      ['Task, Loop and Graph now live under one Tools menu, and the tabs have icons', 'The sidebar had five tabs across the top. The three that start a background run — Task, Loop and Graph — are now one Tools menu instead, the same drop-down the right-hand panel uses: open it and pick one, with an icon beside each. While one is running its section, the Tools button shows that tool’s name and turns green, so you can still see where you are at a glance. Chat and Agents stay where they were, each now with a small icon beside its name.'],
