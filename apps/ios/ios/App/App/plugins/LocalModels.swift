...
public class LocalModels: CAPPlugin, CAPBridgedPlugin {
    ...
    private let catalog: [Entry] = [
        ...
        Entry(id: "gemma4-e2b", name: "Gemma 4 E2B", maker: "Google",
              ...
              gb: 3.58, config: LLMRegistry.gemma4_e2b_it_4bit),
        ...
        Entry(id: "gemma4-e4b", name: "Gemma 4 E4B", maker: "Google",
              ...
              gb: 5.18, config: LLMRegistry.gemma4_e4b_it_4bit),
        ...
        Entry(id: "qwen2.5-vl-3b", name: "Qwen 2.5 VL 3B", maker: "Alibaba",
              blurb: "Good at charts and dense text. The 3 VL below is its successor.",
              gb: 3.09, config: rxRepo("mlx-community/Qwen2.5-VL-3B-Instruct-4bit"), vision: true),
        Entry(id: "qwen3-vl-2b", name: "Qwen 3 VL 2B", maker: "Alibaba",
              blurb: "The newer generation of Qwen's picture models, in the size that fits any iPhone.",
              gb: 1.78, config: rxRepo("mlx-community/Qwen3-VL-2B-Instruct-4bit"), vision: true),
        Entry(id: "qwen3-vl-4b", name: "Qwen 3 VL 4B", maker: "Alibaba",
              blurb: "The most capable of the picture models here. Reads screenshots, documents and charts.",
              gb: 3.09, config: rxRepo("mlx-community/Qwen3-VL-4B-Instruct-4bit"), vision: true),
        ...
        Entry(id: "qwen2.5-coder-3b", name: "Qwen 2.5 Coder 3B", maker: "Alibaba",
              blurb: "Tuned for writing and explaining code. Small enough to keep around.",
              gb: 1.74, config: rxRepo("mlx-community/Qwen2.5-Coder-3B-Instruct-4bit")),
        ...
        // ---- Mistral ----
        Entry(id: "ministral3-8b", name: "Ministral 3 8B", maker: "Mistral",
              blurb: "Mistral's larger phone model. Needs a 12 GB iPhone or an iPad.",
              gb: 5.60, config: rxRepo("mlx-community/Ministral-3-8B-Instruct-2512-4bit")),
