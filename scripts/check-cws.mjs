...
// uploaded and submitted the same day with auto-publish on; by 2026-09-13
// Chrome's update service was serving a CRX whose manifest says 0.8.8, so
// Google approved it within three days.
